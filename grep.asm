...
main(int argc, char *argv[])
{
  ...
  43:	6a 00                	push   $0x0
  45:	ff 33                	pushl  (%ebx)
  47:	e8 7e 05 00 00       	call   5ca <open>
  ...
  6a:	e8 43 05 00 00       	call   5b2 <close>
  if(argc <= 2){
    grep(pattern, 0);
    exit(0);
  }
  ...
  8b:	e8 40 06 00 00       	call   6d0 <printf>
      exit(-1);
  90:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
...
grep(char *pattern, int fd)
{
 ...
 270:	e8 2d 03 00 00       	call   5a2 <read>
 ...
 2d9:	6a 01                	push   $0x1
 2db:	e8 ca 02 00 00       	call   5aa <write>
...
gets(char *buf, int max)
{
 ...
 465:	57                   	push   %edi
 466:	6a 00                	push   $0x0
 468:	e8 35 01 00 00       	call   5a2 <read>
    if(cc < 1)
...
putc(int fd, char c)
{
 ...
 6a8:	e8 fd fe ff ff       	call   5aa <write>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
...
putc(int fd, char c)
{
 ...
 718:	50                   	push   %eax
 719:	57                   	push   %edi
 71a:	e8 8b fe ff ff       	call   5aa <write>
...
putc(int fd, char c)
{
 ...
 77a:	50                   	push   %eax
 77b:	57                   	push   %edi
 77c:	e8 29 fe ff ff       	call   5aa <write>
 ...
 791:	e8 14 fe ff ff       	call   5aa <write>
  int c, i, state;
  uint *ap;
...
putc(int fd, char c)
{
 ...
 80e:	50                   	push   %eax
 80f:	57                   	push   %edi
 810:	e8 95 fd ff ff       	call   5aa <write>
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
...
putc(int fd, char c)
{
 ...
 85f:	50                   	push   %eax
 860:	57                   	push   %edi
 861:	e8 44 fd ff ff       	call   5aa <write>
...
malloc(uint nbytes)
{
 ...
 96e:	53                   	push   %ebx
 96f:	e8 9e fc ff ff       	call   612 <sbrk>
  if(p == (char*)-1)
