...
putc(int fd, char c)
{
 ...
 6b8:	e8 ed fe ff ff       	call   5aa <write>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
...
putc(int fd, char c)
{
 ...
 728:	50                   	push   %eax
 729:	57                   	push   %edi
 72a:	e8 7b fe ff ff       	call   5aa <write>
...
putc(int fd, char c)
{
 ...
 78a:	50                   	push   %eax
 78b:	57                   	push   %edi
 78c:	e8 19 fe ff ff       	call   5aa <write>
...
putc(int fd, char c)
{
 ...
 81e:	50                   	push   %eax
 81f:	57                   	push   %edi
 820:	e8 85 fd ff ff       	call   5aa <write>
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
...
putc(int fd, char c)
{
 ...
 86f:	50                   	push   %eax
 870:	57                   	push   %edi
 871:	e8 34 fd ff ff       	call   5aa <write>
...
malloc(uint nbytes)
{
 ...
 97e:	53                   	push   %ebx
 97f:	e8 8e fc ff ff       	call   612 <sbrk>
  if(p == (char*)-1)
