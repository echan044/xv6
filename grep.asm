...
main(int argc, char *argv[])
{
  ...
  43:	6a 00                	push   $0x0
  45:	ff 33                	pushl  (%ebx)
  47:	e8 86 05 00 00       	call   5d2 <open>
  ...
  6a:	e8 4b 05 00 00       	call   5ba <close>
  if(argc <= 2){
    grep(pattern, 0);
    exit(0);
  }
...
grep(char *pattern, int fd)
{
 ...
 270:	e8 35 03 00 00       	call   5aa <read>
 ...
 2d9:	6a 01                	push   $0x1
 2db:	e8 d2 02 00 00       	call   5b2 <write>
...
gets(char *buf, int max)
{
 ...
 465:	57                   	push   %edi
 466:	6a 00                	push   $0x0
 468:	e8 3d 01 00 00       	call   5aa <read>
    if(cc < 1)
