...
main(int argc, char *argv[])
{
  ...
  7a:	e8 a1 04 00 00       	call   520 <printf>
      exit(-1);
  7f:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
...
wc(int fd, char *name)
{
  ...
  e0:	e8 0d 03 00 00       	call   3f2 <read>
 ...
 17f:	e8 9c 03 00 00       	call   520 <printf>
    exit(-1);
 184:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
...
gets(char *buf, int max)
{
 ...
 2b5:	57                   	push   %edi
 2b6:	6a 00                	push   $0x0
 2b8:	e8 35 01 00 00       	call   3f2 <read>
    if(cc < 1)
...
putc(int fd, char c)
{
 ...
 4f8:	e8 fd fe ff ff       	call   3fa <write>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
...
putc(int fd, char c)
{
 ...
 568:	50                   	push   %eax
 569:	57                   	push   %edi
 56a:	e8 8b fe ff ff       	call   3fa <write>
...
putc(int fd, char c)
{
 ...
 5ca:	50                   	push   %eax
 5cb:	57                   	push   %edi
 5cc:	e8 29 fe ff ff       	call   3fa <write>
 ...
 5e1:	e8 14 fe ff ff       	call   3fa <write>
  int c, i, state;
  uint *ap;
...
putc(int fd, char c)
{
 ...
 65e:	50                   	push   %eax
 65f:	57                   	push   %edi
 660:	e8 95 fd ff ff       	call   3fa <write>
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
...
putc(int fd, char c)
{
 ...
 6af:	50                   	push   %eax
 6b0:	57                   	push   %edi
 6b1:	e8 44 fd ff ff       	call   3fa <write>
...
malloc(uint nbytes)
{
 ...
 7be:	53                   	push   %ebx
 7bf:	e8 9e fc ff ff       	call   462 <sbrk>
  if(p == (char*)-1)
