...
putc(int fd, char c)
{
 ...
 578:	50                   	push   %eax
 579:	57                   	push   %edi
 57a:	e8 7b fe ff ff       	call   3fa <write>
...
putc(int fd, char c)
{
 ...
 5da:	50                   	push   %eax
 5db:	57                   	push   %edi
 5dc:	e8 19 fe ff ff       	call   3fa <write>
...
putc(int fd, char c)
{
 ...
 66e:	50                   	push   %eax
 66f:	57                   	push   %edi
 670:	e8 85 fd ff ff       	call   3fa <write>
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
...
putc(int fd, char c)
{
 ...
 6bf:	50                   	push   %eax
 6c0:	57                   	push   %edi
 6c1:	e8 34 fd ff ff       	call   3fa <write>
...
malloc(uint nbytes)
{
 ...
 7ce:	53                   	push   %ebx
 7cf:	e8 8e fc ff ff       	call   462 <sbrk>
  if(p == (char*)-1)
