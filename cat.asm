...
putc(int fd, char c)
{
 ...
 498:	e8 fd fe ff ff       	call   39a <write>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
...
putc(int fd, char c)
{
 ...
 508:	50                   	push   %eax
 509:	57                   	push   %edi
 50a:	e8 8b fe ff ff       	call   39a <write>
...
putc(int fd, char c)
{
 ...
 56a:	50                   	push   %eax
 56b:	57                   	push   %edi
 56c:	e8 29 fe ff ff       	call   39a <write>
 ...
 581:	e8 14 fe ff ff       	call   39a <write>
  int c, i, state;
  uint *ap;
...
putc(int fd, char c)
{
 ...
 5fe:	50                   	push   %eax
 5ff:	57                   	push   %edi
 600:	e8 95 fd ff ff       	call   39a <write>
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
...
putc(int fd, char c)
{
 ...
 64f:	50                   	push   %eax
 650:	57                   	push   %edi
 651:	e8 44 fd ff ff       	call   39a <write>
...
malloc(uint nbytes)
{
 ...
 75e:	53                   	push   %ebx
 75f:	e8 9e fc ff ff       	call   402 <sbrk>
  if(p == (char*)-1)
