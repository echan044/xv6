...
main(int argc, char *argv[])
{
  ...
  33:	6a 00                	push   $0x0
  35:	ff 33                	pushl  (%ebx)
  37:	e8 7e 03 00 00       	call   3ba <open>
  ...
  57:	e8 46 03 00 00       	call   3a2 <close>
  if(argc <= 1){
    cat(0);
    exit(0);
  }
  ...
  78:	e8 53 04 00 00       	call   4d0 <printf>
      exit(-1);
  7d:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
...
cat(int fd)
{
  ...
  b9:	6a 01                	push   $0x1
  bb:	e8 da 02 00 00       	call   39a <write>
...
cat(int fd)
{
  ...
  d4:	56                   	push   %esi
  d5:	e8 b8 02 00 00       	call   392 <read>
  ...
  ec:	c3                   	ret    
{
  ...
  f7:	e8 d4 03 00 00       	call   4d0 <printf>
      exit(-1);
  fc:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
 ...
 112:	e8 b9 03 00 00       	call   4d0 <printf>
    exit(-1);
 117:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
...
gets(char *buf, int max)
{
 ...
 255:	57                   	push   %edi
 256:	6a 00                	push   $0x0
 258:	e8 35 01 00 00       	call   392 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 2bd:	e8 f8 00 00 00       	call   3ba <open>
  if(fd < 0)
 ...
 2d1:	50                   	push   %eax
 2d2:	e8 fb 00 00 00       	call   3d2 <fstat>
 2d7:	89 c6                	mov    %eax,%esi
  close(fd);
 2d9:	89 1c 24             	mov    %ebx,(%esp)
 2dc:	e8 c1 00 00 00       	call   3a2 <close>
  return r;
...
putc(int fd, char c)
{
 ...
 4a8:	e8 ed fe ff ff       	call   39a <write>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
...
putc(int fd, char c)
{
 ...
 518:	50                   	push   %eax
 519:	57                   	push   %edi
 51a:	e8 7b fe ff ff       	call   39a <write>
...
putc(int fd, char c)
{
 ...
 57a:	50                   	push   %eax
 57b:	57                   	push   %edi
 57c:	e8 19 fe ff ff       	call   39a <write>
 ...
 591:	e8 04 fe ff ff       	call   39a <write>
  int c, i, state;
  uint *ap;
...
putc(int fd, char c)
{
 ...
 60e:	50                   	push   %eax
 60f:	57                   	push   %edi
 610:	e8 85 fd ff ff       	call   39a <write>
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
...
putc(int fd, char c)
{
 ...
 65f:	50                   	push   %eax
 660:	57                   	push   %edi
 661:	e8 34 fd ff ff       	call   39a <write>
...
malloc(uint nbytes)
{
 ...
 76e:	53                   	push   %ebx
 76f:	e8 8e fc ff ff       	call   402 <sbrk>
  if(p == (char*)-1)
