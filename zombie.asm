...
gets(char *buf, int max)
{
 ...
 165:	57                   	push   %edi
 166:	6a 00                	push   $0x0
 168:	e8 35 01 00 00       	call   2a2 <read>
    if(cc < 1)
...
putc(int fd, char c)
{
 ...
 3a8:	e8 fd fe ff ff       	call   2aa <write>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
...
putc(int fd, char c)
{
 ...
 418:	50                   	push   %eax
 419:	57                   	push   %edi
 41a:	e8 8b fe ff ff       	call   2aa <write>
...
putc(int fd, char c)
{
 ...
 47a:	50                   	push   %eax
 47b:	57                   	push   %edi
 47c:	e8 29 fe ff ff       	call   2aa <write>
 ...
 491:	e8 14 fe ff ff       	call   2aa <write>
  int c, i, state;
  uint *ap;
...
putc(int fd, char c)
{
 ...
 50e:	50                   	push   %eax
 50f:	57                   	push   %edi
 510:	e8 95 fd ff ff       	call   2aa <write>
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
...
putc(int fd, char c)
{
 ...
 55f:	50                   	push   %eax
 560:	57                   	push   %edi
 561:	e8 44 fd ff ff       	call   2aa <write>
...
malloc(uint nbytes)
{
 ...
 66e:	53                   	push   %ebx
 66f:	e8 9e fc ff ff       	call   312 <sbrk>
  if(p == (char*)-1)
