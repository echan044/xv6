...
putc(int fd, char c)
{
 ...
 3b8:	e8 ed fe ff ff       	call   2aa <write>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
...
putc(int fd, char c)
{
 ...
 428:	50                   	push   %eax
 429:	57                   	push   %edi
 42a:	e8 7b fe ff ff       	call   2aa <write>
...
putc(int fd, char c)
{
 ...
 48a:	50                   	push   %eax
 48b:	57                   	push   %edi
 48c:	e8 19 fe ff ff       	call   2aa <write>
 ...
 4a1:	e8 04 fe ff ff       	call   2aa <write>
  int c, i, state;
  uint *ap;
...
putc(int fd, char c)
{
 ...
 51e:	50                   	push   %eax
 51f:	57                   	push   %edi
 520:	e8 85 fd ff ff       	call   2aa <write>
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
...
putc(int fd, char c)
{
 ...
 56f:	50                   	push   %eax
 570:	57                   	push   %edi
 571:	e8 34 fd ff ff       	call   2aa <write>
