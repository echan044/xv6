...
putc(int fd, char c)
{
 ...
 648:	e8 ed fe ff ff       	call   53a <write>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
...
putc(int fd, char c)
{
 ...
 6b8:	50                   	push   %eax
 6b9:	57                   	push   %edi
 6ba:	e8 7b fe ff ff       	call   53a <write>
...
putc(int fd, char c)
{
 ...
 71a:	50                   	push   %eax
 71b:	57                   	push   %edi
 71c:	e8 19 fe ff ff       	call   53a <write>
...
putc(int fd, char c)
{
 ...
 7ae:	50                   	push   %eax
 7af:	57                   	push   %edi
 7b0:	e8 85 fd ff ff       	call   53a <write>
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
...
putc(int fd, char c)
{
 ...
 7ff:	50                   	push   %eax
 800:	57                   	push   %edi
 801:	e8 34 fd ff ff       	call   53a <write>
...
malloc(uint nbytes)
{
 ...
 90e:	53                   	push   %ebx
 90f:	e8 8e fc ff ff       	call   5a2 <sbrk>
  if(p == (char*)-1)
