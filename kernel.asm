...
80105283:	e8 38 1c 00 00       	call   80106ec0 <shm_close>
}
80105288:	c9                   	leave  
80105289:	c3                   	ret    
...
//you write this
  int i;
  initlock(&(shm_table.lock), "SHM lock");
80106cfc:	c7 44 24 04 34 79 10 	movl   $0x80107934,0x4(%esp)
80106d03:	80 
80106d04:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106d0b:	e8 50 d3 ff ff       	call   80104060 <initlock>
  acquire(&shm_table.lock);
80106d10:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106d17:	e8 34 d4 ff ff       	call   80104150 <acquire>
80106d1c:	ba f4 54 11 80       	mov    $0x801154f4,%edx
  for(i = 0; i < 64; i++) {
80106d21:	31 c0                	xor    %eax,%eax
80106d23:	eb 12                	jmp    80106d37 <shm_open+0x47>
...
80106d31:	0f 84 a9 00 00 00    	je     80106de0 <shm_open+0xf0>
    if (shm_table.shm_pages[i].id == id) {
80106d37:	3b 1a                	cmp    (%edx),%ebx
80106d39:	75 ed                	jne    80106d28 <shm_open+0x38>
      mappages(myproc()->pgdir, (void*) PGROUNDUP(myproc()->sz), PGSIZE, V2P(shm_table.shm_pages[i].frame), PTE_W|PTE_U);
80106d3b:	8d 1c 40             	lea    (%eax,%eax,2),%ebx
80106d3e:	c1 e3 02             	shl    $0x2,%ebx
80106d41:	8b 83 f8 54 11 80    	mov    -0x7feeab08(%ebx),%eax
80106d47:	8d b8 00 00 00 80    	lea    -0x80000000(%eax),%edi
80106d4d:	e8 5e c9 ff ff       	call   801036b0 <myproc>
80106d52:	8b 30                	mov    (%eax),%esi
80106d54:	e8 57 c9 ff ff       	call   801036b0 <myproc>
80106d59:	89 7c 24 0c          	mov    %edi,0xc(%esp)
80106d5d:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80106d64:	00 
80106d65:	81 c6 ff 0f 00 00    	add    $0xfff,%esi
80106d6b:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
80106d71:	89 74 24 04          	mov    %esi,0x4(%esp)
80106d75:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106d7c:	00 
80106d7d:	8b 40 04             	mov    0x4(%eax),%eax
80106d80:	89 04 24             	mov    %eax,(%esp)
80106d83:	e8 c8 f7 ff ff       	call   80106550 <mappages>
      shm_table.shm_pages[i].refcnt += 1;
80106d88:	83 83 fc 54 11 80 01 	addl   $0x1,-0x7feeab04(%ebx)
      *pointer = (char*)(PGROUNDUP(myproc()->sz));
80106d8f:	e8 1c c9 ff ff       	call   801036b0 <myproc>
80106d94:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106d97:	8b 00                	mov    (%eax),%eax
80106d99:	05 ff 0f 00 00       	add    $0xfff,%eax
80106d9e:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80106da3:	89 01                	mov    %eax,(%ecx)
      myproc()->sz = PGROUNDUP(myproc()->sz) + PGSIZE;
80106da5:	e8 06 c9 ff ff       	call   801036b0 <myproc>
80106daa:	89 c3                	mov    %eax,%ebx
80106dac:	e8 ff c8 ff ff       	call   801036b0 <myproc>
80106db1:	8b 10                	mov    (%eax),%edx
80106db3:	81 c2 ff 0f 00 00    	add    $0xfff,%edx
80106db9:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
80106dbf:	81 c2 00 10 00 00    	add    $0x1000,%edx
80106dc5:	89 13                	mov    %edx,(%ebx)
      release(&(shm_table.lock));
80106dc7:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106dce:	e8 6d d4 ff ff       	call   80104240 <release>
    }
...
80106dd3:	83 c4 2c             	add    $0x2c,%esp
...
80106ddd:	8d 76 00             	lea    0x0(%esi),%esi
  for(i = 0; i < 64; i++) {
80106de0:	ba f4 54 11 80       	mov    $0x801154f4,%edx
80106de5:	30 c0                	xor    %al,%al
80106de7:	eb 16                	jmp    80106dff <shm_open+0x10f>
80106de9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
   for(i = 0; i < 64; i++) {
80106df0:	83 c0 01             	add    $0x1,%eax
80106df3:	83 c2 0c             	add    $0xc,%edx
80106df6:	83 f8 40             	cmp    $0x40,%eax
80106df9:	0f 84 a7 00 00 00    	je     80106ea6 <shm_open+0x1b6>
    if(shm_table.shm_pages[i].id == 0) {
80106dff:	8b 0a                	mov    (%edx),%ecx
80106e01:	85 c9                	test   %ecx,%ecx
80106e03:	75 eb                	jne    80106df0 <shm_open+0x100>
      shm_table.shm_pages[i].id = id;
80106e05:	8d 34 40             	lea    (%eax,%eax,2),%esi
80106e08:	c1 e6 02             	shl    $0x2,%esi
80106e0b:	89 9e f4 54 11 80    	mov    %ebx,-0x7feeab0c(%esi)
      char* newPage = kalloc();
80106e11:	e8 9a b6 ff ff       	call   801024b0 <kalloc>
      memset(newPage, 0, PGSIZE);
80106e16:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106e1d:	00 
80106e1e:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106e25:	00 
      char* newPage = kalloc();
80106e26:	89 c3                	mov    %eax,%ebx
      memset(newPage, 0, PGSIZE);
80106e28:	89 04 24             	mov    %eax,(%esp)
80106e2b:	e8 60 d4 ff ff       	call   80104290 <memset>
      if(!newPage){
80106e30:	85 db                	test   %ebx,%ebx
80106e32:	74 72                	je     80106ea6 <shm_open+0x1b6>
	shm_table.shm_pages[i].frame = newPage;
80106e34:	89 9e f8 54 11 80    	mov    %ebx,-0x7feeab08(%esi)
      mappages(myproc()->pgdir, (void *) PGROUNDUP(myproc()->sz), PGSIZE, V2P(shm_table.shm_pages[i].frame), PTE_W|PTE_U);
80106e3a:	81 c3 00 00 00 80    	add    $0x80000000,%ebx
      shm_table.shm_pages[i].refcnt = 1;
80106e40:	c7 86 fc 54 11 80 01 	movl   $0x1,-0x7feeab04(%esi)
80106e47:	00 00 00 
      mappages(myproc()->pgdir, (void *) PGROUNDUP(myproc()->sz), PGSIZE, V2P(shm_table.shm_pages[i].frame), PTE_W|PTE_U);
80106e4a:	e8 61 c8 ff ff       	call   801036b0 <myproc>
80106e4f:	8b 30                	mov    (%eax),%esi
80106e51:	e8 5a c8 ff ff       	call   801036b0 <myproc>
80106e56:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80106e5d:	00 
80106e5e:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
80106e62:	81 c6 ff 0f 00 00    	add    $0xfff,%esi
80106e68:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
80106e6e:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106e75:	00 
80106e76:	89 74 24 04          	mov    %esi,0x4(%esp)
80106e7a:	8b 40 04             	mov    0x4(%eax),%eax
80106e7d:	89 04 24             	mov    %eax,(%esp)
80106e80:	e8 cb f6 ff ff       	call   80106550 <mappages>
      *pointer = (char*)(PGROUNDUP(myproc()->sz));
80106e85:	e8 26 c8 ff ff       	call   801036b0 <myproc>
80106e8a:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106e8d:	8b 00                	mov    (%eax),%eax
80106e8f:	05 ff 0f 00 00       	add    $0xfff,%eax
80106e94:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80106e99:	89 01                	mov    %eax,(%ecx)
      myproc()->sz += PGSIZE;
80106e9b:	e8 10 c8 ff ff       	call   801036b0 <myproc>
80106ea0:	81 00 00 10 00 00    	addl   $0x1000,(%eax)
      release(&(shm_table.lock));
80106ea6:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106ead:	e8 8e d3 ff ff       	call   80104240 <release>
}
80106eb2:	83 c4 2c             	add    $0x2c,%esp
80106eb5:	31 c0                	xor    %eax,%eax
80106eb7:	5b                   	pop    %ebx
80106eb8:	5e                   	pop    %esi
80106eb9:	5f                   	pop    %edi
80106eba:	5d                   	pop    %ebp
...
80106ec4:	83 ec 14             	sub    $0x14,%esp
80106ec7:	8b 5d 08             	mov    0x8(%ebp),%ebx
//you write this too!
  int i;

  initlock(&(shm_table.lock), "SHM lock");
80106eca:	c7 44 24 04 34 79 10 	movl   $0x80107934,0x4(%esp)
80106ed1:	80 
80106ed2:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106ed9:	e8 82 d1 ff ff       	call   80104060 <initlock>
  acquire(&(shm_table.lock));
80106ede:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106ee5:	e8 66 d2 ff ff       	call   80104150 <acquire>
80106eea:	ba f4 54 11 80       	mov    $0x801154f4,%edx

  for(i = 0; i < 64; i++){
80106eef:	31 c0                	xor    %eax,%eax
80106ef1:	eb 10                	jmp    80106f03 <shm_close+0x43>
80106ef3:	90                   	nop
80106ef4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80106ef8:	83 c0 01             	add    $0x1,%eax
80106efb:	83 c2 0c             	add    $0xc,%edx
80106efe:	83 f8 40             	cmp    $0x40,%eax
80106f01:	74 1d                	je     80106f20 <shm_close+0x60>
    if(shm_table.shm_pages[i].id == id){
80106f03:	39 1a                	cmp    %ebx,(%edx)
80106f05:	75 f1                	jne    80106ef8 <shm_close+0x38>
      shm_table.shm_pages[i].refcnt -= 1;
80106f07:	8d 0c 40             	lea    (%eax,%eax,2),%ecx
80106f0a:	c1 e1 02             	shl    $0x2,%ecx

      if(shm_table.shm_pages[i].refcnt == 0)
80106f0d:	83 a9 fc 54 11 80 01 	subl   $0x1,-0x7feeab04(%ecx)
80106f14:	75 0a                	jne    80106f20 <shm_close+0x60>
	shm_table.shm_pages[i].id = 0;
80106f16:	c7 81 f4 54 11 80 00 	movl   $0x0,-0x7feeab0c(%ecx)
80106f1d:	00 00 00 
   	break;
     }
  ...
  release(&(shm_table.lock));
80106f20:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106f27:	e8 14 d3 ff ff       	call   80104240 <release>

  return 0;
}
80106f2c:	83 c4 14             	add    $0x14,%esp
