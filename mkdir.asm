...
gets(char *buf, int max)
{
 ...
 1b5:	57                   	push   %edi
 1b6:	6a 00                	push   $0x0
 1b8:	e8 35 01 00 00       	call   2f2 <read>
    if(cc < 1)
...
putc(int fd, char c)
{
 ...
 3f8:	e8 fd fe ff ff       	call   2fa <write>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
...
putc(int fd, char c)
{
 ...
 468:	50                   	push   %eax
 469:	57                   	push   %edi
 46a:	e8 8b fe ff ff       	call   2fa <write>
...
putc(int fd, char c)
{
 ...
 4ca:	50                   	push   %eax
 4cb:	57                   	push   %edi
 4cc:	e8 29 fe ff ff       	call   2fa <write>
 ...
 4e1:	e8 14 fe ff ff       	call   2fa <write>
  int c, i, state;
  uint *ap;
...
putc(int fd, char c)
{
 ...
 55e:	50                   	push   %eax
 55f:	57                   	push   %edi
 560:	e8 95 fd ff ff       	call   2fa <write>
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
...
putc(int fd, char c)
{
 ...
 5af:	50                   	push   %eax
 5b0:	57                   	push   %edi
 5b1:	e8 44 fd ff ff       	call   2fa <write>
...
malloc(uint nbytes)
{
 ...
 6be:	53                   	push   %ebx
 6bf:	e8 9e fc ff ff       	call   362 <sbrk>
  if(p == (char*)-1)
