...
putc(int fd, char c)
{
  write(fd, &c, 1);
     ...
     e88:	e8 fd fe ff ff       	call   d8a <write>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
...
putc(int fd, char c)
{
  write(fd, &c, 1);
     ...
     ef8:	50                   	push   %eax
     ef9:	57                   	push   %edi
     efa:	e8 8b fe ff ff       	call   d8a <write>
...
putc(int fd, char c)
{
  write(fd, &c, 1);
     ...
     f5a:	50                   	push   %eax
     f5b:	57                   	push   %edi
     f5c:	e8 29 fe ff ff       	call   d8a <write>
     ...
     f71:	e8 14 fe ff ff       	call   d8a <write>
  int c, i, state;
  uint *ap;
...
putc(int fd, char c)
{
  write(fd, &c, 1);
     fee:	50                   	push   %eax
     fef:	57                   	push   %edi
     ff0:	e8 95 fd ff ff       	call   d8a <write>
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
...
putc(int fd, char c)
{
  write(fd, &c, 1);
    ...
    103f:	50                   	push   %eax
    1040:	57                   	push   %edi
    1041:	e8 44 fd ff ff       	call   d8a <write>
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    114e:	53                   	push   %ebx
    114f:	e8 9e fc ff ff       	call   df2 <sbrk>
  if(p == (char*)-1)
