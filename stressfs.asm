...
putc(int fd, char c)
{
 ...
 4b8:	e8 ed fe ff ff       	call   3aa <write>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
...
putc(int fd, char c)
{
 ...
 528:	50                   	push   %eax
 529:	57                   	push   %edi
 52a:	e8 7b fe ff ff       	call   3aa <write>
...
putc(int fd, char c)
{
 ...
 58a:	50                   	push   %eax
 58b:	57                   	push   %edi
 58c:	e8 19 fe ff ff       	call   3aa <write>
 ...
 5a1:	e8 04 fe ff ff       	call   3aa <write>
  int c, i, state;
  uint *ap;
...
putc(int fd, char c)
{
 ...
 61e:	50                   	push   %eax
 61f:	57                   	push   %edi
 620:	e8 85 fd ff ff       	call   3aa <write>
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
...
putc(int fd, char c)
{
 ...
 66f:	50                   	push   %eax
 670:	57                   	push   %edi
 671:	e8 34 fd ff ff       	call   3aa <write>
...
malloc(uint nbytes)
{
 ...
 77e:	53                   	push   %ebx
 77f:	e8 8e fc ff ff       	call   412 <sbrk>
  if(p == (char*)-1)
