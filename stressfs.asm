...
main(int argc, char *argv[])
{
  ...
  a2:	50                   	push   %eax
  a3:	e8 22 03 00 00       	call   3ca <open>
...
//    printf(fd, "%d\n", i);
  ...
  b8:	56                   	push   %esi
  b9:	57                   	push   %edi
  ba:	e8 eb 02 00 00       	call   3aa <write>
...
//    printf(fd, "%d\n", i);
  ...
  ca:	57                   	push   %edi
  cb:	e8 e2 02 00 00       	call   3b2 <close>
  ...
  ee:	e8 d7 02 00 00       	call   3ca <open>
 ...
 108:	56                   	push   %esi
 109:	57                   	push   %edi
 10a:	e8 93 02 00 00       	call   3a2 <read>
  close(fd);
 ...
 11a:	57                   	push   %edi
 11b:	e8 92 02 00 00       	call   3b2 <close>
...
gets(char *buf, int max)
{
 ...
 265:	57                   	push   %edi
 266:	6a 00                	push   $0x0
 268:	e8 35 01 00 00       	call   3a2 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 2cd:	e8 f8 00 00 00       	call   3ca <open>
  if(fd < 0)
 ...
 2e1:	50                   	push   %eax
 2e2:	e8 fb 00 00 00       	call   3e2 <fstat>
 2e7:	89 c6                	mov    %eax,%esi
  close(fd);
 2e9:	89 1c 24             	mov    %ebx,(%esp)
 2ec:	e8 c1 00 00 00       	call   3b2 <close>
  return r;
...
putc(int fd, char c)
{
 ...
 4a8:	e8 fd fe ff ff       	call   3aa <write>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
...
putc(int fd, char c)
{
 ...
 518:	50                   	push   %eax
 519:	57                   	push   %edi
 51a:	e8 8b fe ff ff       	call   3aa <write>
...
putc(int fd, char c)
{
 ...
 57a:	50                   	push   %eax
 57b:	57                   	push   %edi
 57c:	e8 29 fe ff ff       	call   3aa <write>
 ...
 591:	e8 14 fe ff ff       	call   3aa <write>
  int c, i, state;
  uint *ap;
...
putc(int fd, char c)
{
 ...
 60e:	50                   	push   %eax
 60f:	57                   	push   %edi
 610:	e8 95 fd ff ff       	call   3aa <write>
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
...
putc(int fd, char c)
{
 ...
 65f:	50                   	push   %eax
 660:	57                   	push   %edi
 661:	e8 44 fd ff ff       	call   3aa <write>
...
malloc(uint nbytes)
{
 ...
 76e:	53                   	push   %ebx
 76f:	e8 9e fc ff ff       	call   412 <sbrk>
  if(p == (char*)-1)
