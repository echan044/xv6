...
putc(int fd, char c)
{
 ...
 408:	e8 ed fe ff ff       	call   2fa <write>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
...
putc(int fd, char c)
{
 ...
 478:	50                   	push   %eax
 479:	57                   	push   %edi
 47a:	e8 7b fe ff ff       	call   2fa <write>
...
putc(int fd, char c)
{
 ...
 4da:	50                   	push   %eax
 4db:	57                   	push   %edi
 4dc:	e8 19 fe ff ff       	call   2fa <write>
 ...
 4f1:	e8 04 fe ff ff       	call   2fa <write>
  int c, i, state;
  uint *ap;
...
putc(int fd, char c)
{
 ...
 56e:	50                   	push   %eax
 56f:	57                   	push   %edi
 570:	e8 85 fd ff ff       	call   2fa <write>
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
...
putc(int fd, char c)
{
 ...
 5bf:	50                   	push   %eax
 5c0:	57                   	push   %edi
 5c1:	e8 34 fd ff ff       	call   2fa <write>
