...
putc(int fd, char c)
{
  write(fd, &c, 1);
    ...
    3fa8:	e8 ed fe ff ff       	call   3e9a <write>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
...
putc(int fd, char c)
{
  write(fd, &c, 1);
    ...
    4018:	50                   	push   %eax
    4019:	57                   	push   %edi
    401a:	e8 7b fe ff ff       	call   3e9a <write>
...
putc(int fd, char c)
{
  write(fd, &c, 1);
    ...
    407a:	50                   	push   %eax
    407b:	57                   	push   %edi
    407c:	e8 19 fe ff ff       	call   3e9a <write>
    ...
    4091:	e8 04 fe ff ff       	call   3e9a <write>
  int c, i, state;
  uint *ap;
...
putc(int fd, char c)
{
  write(fd, &c, 1);
    410e:	50                   	push   %eax
    410f:	57                   	push   %edi
    4110:	e8 85 fd ff ff       	call   3e9a <write>
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
...
putc(int fd, char c)
{
  write(fd, &c, 1);
    ...
    415f:	50                   	push   %eax
    4160:	57                   	push   %edi
    4161:	e8 34 fd ff ff       	call   3e9a <write>
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    426e:	53                   	push   %ebx
    426f:	e8 8e fc ff ff       	call   3f02 <sbrk>
  if(p == (char*)-1)
