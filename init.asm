...
main(void)
{
  ...
  2c:	6a 00                	push   $0x0
  2e:	e8 9f 03 00 00       	call   3d2 <dup>
  dup(0);  // stderr
  33:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  3a:	e8 93 03 00 00       	call   3d2 <dup>
  ...
  a2:	e8 f9 03 00 00       	call   4a0 <printf>
      exit(-1);
  a7:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
  ...
  bf:	e8 ce 02 00 00       	call   392 <exec>
      printf(1, "init: exec sh failed\n");
  c4:	5a                   	pop    %edx
  c5:	59                   	pop    %ecx
  ...
  cd:	e8 ce 03 00 00       	call   4a0 <printf>
      exit(-1);
  d2:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
...
main(void)
{
  ...
  e8:	e8 b5 02 00 00       	call   3a2 <mknod>
    open("console", O_RDWR);
  ed:	58                   	pop    %eax
  ee:	5a                   	pop    %edx
  ef:	6a 02                	push   $0x2
  f1:	68 c0 07 00 00       	push   $0x7c0
  f6:	e8 9f 02 00 00       	call   39a <open>
...
gets(char *buf, int max)
{
 ...
 235:	57                   	push   %edi
 236:	6a 00                	push   $0x0
 238:	e8 35 01 00 00       	call   372 <read>
    if(cc < 1)
...
putc(int fd, char c)
{
 ...
 478:	e8 fd fe ff ff       	call   37a <write>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
...
putc(int fd, char c)
{
 ...
 4e8:	50                   	push   %eax
 4e9:	57                   	push   %edi
 4ea:	e8 8b fe ff ff       	call   37a <write>
...
putc(int fd, char c)
{
 ...
 54a:	50                   	push   %eax
 54b:	57                   	push   %edi
 54c:	e8 29 fe ff ff       	call   37a <write>
 ...
 561:	e8 14 fe ff ff       	call   37a <write>
  int c, i, state;
  uint *ap;
...
putc(int fd, char c)
{
 ...
 5de:	50                   	push   %eax
 5df:	57                   	push   %edi
 5e0:	e8 95 fd ff ff       	call   37a <write>
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
...
putc(int fd, char c)
{
 ...
 62f:	50                   	push   %eax
 630:	57                   	push   %edi
 631:	e8 44 fd ff ff       	call   37a <write>
...
malloc(uint nbytes)
{
 ...
 73e:	53                   	push   %ebx
 73f:	e8 9e fc ff ff       	call   3e2 <sbrk>
  if(p == (char*)-1)
