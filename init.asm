...
putc(int fd, char c)
{
 ...
 488:	e8 ed fe ff ff       	call   37a <write>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
...
putc(int fd, char c)
{
 ...
 4f8:	50                   	push   %eax
 4f9:	57                   	push   %edi
 4fa:	e8 7b fe ff ff       	call   37a <write>
...
putc(int fd, char c)
{
 ...
 55a:	50                   	push   %eax
 55b:	57                   	push   %edi
 55c:	e8 19 fe ff ff       	call   37a <write>
 ...
 571:	e8 04 fe ff ff       	call   37a <write>
  int c, i, state;
  uint *ap;
...
putc(int fd, char c)
{
 ...
 5ee:	50                   	push   %eax
 5ef:	57                   	push   %edi
 5f0:	e8 85 fd ff ff       	call   37a <write>
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
...
putc(int fd, char c)
{
 ...
 63f:	50                   	push   %eax
 640:	57                   	push   %edi
 641:	e8 34 fd ff ff       	call   37a <write>
...
malloc(uint nbytes)
{
 ...
 74e:	53                   	push   %ebx
 74f:	e8 8e fc ff ff       	call   3e2 <sbrk>
  if(p == (char*)-1)
