...
main(int argc, char *argv[])
{
  ...
  3a:	e8 db 02 00 00       	call   31a <link>
...
gets(char *buf, int max)
{
 ...
 195:	57                   	push   %edi
 196:	6a 00                	push   $0x0
 198:	e8 35 01 00 00       	call   2d2 <read>
    if(cc < 1)
...
putc(int fd, char c)
{
 ...
 3d8:	e8 fd fe ff ff       	call   2da <write>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
...
putc(int fd, char c)
{
 ...
 448:	50                   	push   %eax
 449:	57                   	push   %edi
 44a:	e8 8b fe ff ff       	call   2da <write>
...
putc(int fd, char c)
{
 ...
 4aa:	50                   	push   %eax
 4ab:	57                   	push   %edi
 4ac:	e8 29 fe ff ff       	call   2da <write>
 ...
 4c1:	e8 14 fe ff ff       	call   2da <write>
  int c, i, state;
  uint *ap;
...
putc(int fd, char c)
{
 ...
 53e:	50                   	push   %eax
 53f:	57                   	push   %edi
 540:	e8 95 fd ff ff       	call   2da <write>
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
...
putc(int fd, char c)
{
 ...
 58f:	50                   	push   %eax
 590:	57                   	push   %edi
 591:	e8 44 fd ff ff       	call   2da <write>
...
malloc(uint nbytes)
{
 ...
 69e:	53                   	push   %ebx
 69f:	e8 9e fc ff ff       	call   342 <sbrk>
  if(p == (char*)-1)
