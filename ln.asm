...
putc(int fd, char c)
{
 ...
 3e8:	e8 ed fe ff ff       	call   2da <write>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
...
putc(int fd, char c)
{
 ...
 458:	50                   	push   %eax
 459:	57                   	push   %edi
 45a:	e8 7b fe ff ff       	call   2da <write>
...
putc(int fd, char c)
{
 ...
 4ba:	50                   	push   %eax
 4bb:	57                   	push   %edi
 4bc:	e8 19 fe ff ff       	call   2da <write>
 ...
 4d1:	e8 04 fe ff ff       	call   2da <write>
  int c, i, state;
  uint *ap;
...
putc(int fd, char c)
{
 ...
 54e:	50                   	push   %eax
 54f:	57                   	push   %edi
 550:	e8 85 fd ff ff       	call   2da <write>
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
...
putc(int fd, char c)
{
 ...
 59f:	50                   	push   %eax
 5a0:	57                   	push   %edi
 5a1:	e8 34 fd ff ff       	call   2da <write>
